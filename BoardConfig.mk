...
TARGET_BOOTLOADER_BOARD_NAME := zumapro
else ifeq ($(DEVICE_BUILD_FLAG),gs201)
TARGET_BOOTLOADER_BOARD_NAME := gs201
else ifeq ($(DEVICE_BUILD_FLAG),gs101)
TARGET_BOOTLOADER_BOARD_NAME := gs101
else
TARGET_BOOTLOADER_BOARD_NAME := zuma
endif
...
GOOGLE_BOARD_PLATFORMS += gs201
TARGET_BOARD_PLATFORM := gs201
PRODUCT_PLATFORM := gs201
else ifeq ($(DEVICE_BUILD_FLAG),gs101)
GOOGLE_BOARD_PLATFORMS += gs101
TARGET_BOARD_PLATFORM := gs101
PRODUCT_PLATFORM := gs101
else
